...
table_s2_1 <- tab_model(glmm_cci, show.se = TRUE, show.stat = TRUE, transform = NULL, file = file.path(figure_path, "table_s2_1.doc"))
tab_model(glmm_cci, show.se = TRUE, show.stat = TRUE, transform = NULL, file = file.path(figure_path, "table_s2_1.doc"))
table_s2_2 <- tab_model(glmm_coi_1, show.se = TRUE, show.stat = TRUE, transform = NULL, file = file.path(figure_path, "table_s2_1.doc"))
tab_model(glmm_coi_1, show.se = TRUE, show.stat = TRUE, transform = NULL, file = file.path(figure_path, "table_s2_1.doc"))
```
